...
namespace X.UI.Consoles.Stock
{
    ...
    //策略2:10日内出现涨停收盘, 3日真实波动率大于4%, 3日均线向上、股价位于3日均线上方, 回踩3日线位置（盘中计算3日线动态位置）时买入;次日高抛.
    //策略3:连续5日趋势向上, 5日真实波动率大于4%, 5日均线向上、股价位于5日均线上方, 回踩5日线位置（盘中计算5日线动态位置）时买入;次日高抛.
    //策略4:连续5日趋势向上, 3日真实波动率大于4%, 3日均线向上、股价位于3日均线上方, 回踩3日线位置（盘中计算3日线动态位置）时买入;次日高抛.
    //策略5:连续5日趋势向上, 热点题材突破甚至涨停
    //策略6:
