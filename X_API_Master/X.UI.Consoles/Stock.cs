    ...
    public class StockPerformanceHelper
    {
        public static List<StockPerformance> Init(DateTime start)
        {
            var ret = new List<StockPerformance>
            {
                ...
                {
                    StockCode = "300675",
                    CurrentDate = new DateTime(2017, 8, 31),
                    Operate = Operate.Buy,
                    Profit = 3
                },
                new StockPerformance
                ...
                {
                    StockCode = "300675",
                    CurrentDate = new DateTime(2017, 9, 1),
                    Operate = Operate.Sell,
                    Profit = -2
                },
                new StockPerformance
                ...
                {
                    StockCode = "601225",
                    CurrentDate = new DateTime(2017, 9, 4),
                    Operate = Operate.Sell,
                    Profit = -0.5
                },
                new StockPerformance
                ...
                {
                    StockCode = "603595",
                    CurrentDate = new DateTime(2017, 9, 5),
                    Operate = Operate.Sell,
                    Profit = -0.7
                },
                new StockPerformance
                ...
                {
                    StockCode = "300520",
                    CurrentDate = new DateTime(2017, 9, 6),
                    Operate = Operate.Buy,
                    Profit = 4.5
                },
                new StockPerformance
                ...
                {
                    StockCode = "300520",
                    CurrentDate = new DateTime(2017, 9, 7),
                    Operate = Operate.Buy,
                    Profit = 6.5
                },
                //2017-09-08
                ...
                {
                    StockCode = "002497",
                    CurrentDate = new DateTime(2017, 9, 13),
                    Operate = Operate.None,
                    Profit = 10
                },
                #endregion
