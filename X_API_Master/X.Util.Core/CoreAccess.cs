...
namespace X.Util.Core
{
    ...
    public sealed class CoreAccess<TChannel>
    {
        ...
        {
            var method = Logger.GetMethodInfo(func.Method, new object[] { }, channel.EndpointAddress);
            if (needLogInfo) Logger.Info(method, eDomain, null, string.Format("{0}.{1} BeginInvoke.", typeof(TChannel).FullName, func.Method.Name));
            var iresult = func();
            channel.Close(func.Method, eDomain);
            if (callSuccess(iresult))
            {
                if (needLogInfo) Logger.Info(method, eDomain, iresult);
            }
            else Logger.Error(method, eDomain, iresult);
            if (needLogInfo) Logger.Info(method, eDomain, null, string.Format("{0}.{1} EndInvoke.", typeof(TChannel).FullName, func.Method.Name));
            return iresult;
        }
        ...
        {
            var method = Logger.GetMethodInfo(func.Method, new object[] { t1 }, channel.EndpointAddress);
            if (needLogInfo) Logger.Info(method, eDomain, null, string.Format("{0}.{1} BeginInvoke.", typeof(TChannel).FullName, func.Method.Name));
            var iresult = func(t1);
            channel.Close(func.Method, eDomain);
            if (callSuccess(iresult))
        ...
        {
            var method = Logger.GetMethodInfo(func.Method, new object[] { t1, t2 }, channel.EndpointAddress);
            if (needLogInfo) Logger.Info(method, eDomain, null, string.Format("{0}.{1} BeginInvoke.", typeof(TChannel).FullName, func.Method.Name));
        ...
        {
            var method = Logger.GetMethodInfo(func.Method, new object[] { t1, t2, t3 }, channel.EndpointAddress);
            if (needLogInfo) Logger.Info(method, eDomain, null, string.Format("{0}.{1} BeginInvoke.", typeof(TChannel).FullName, func.Method.Name));
        ...
        {
            var method = Logger.GetMethodInfo(func.Method, new object[] { t1, t2, t3, t4 }, channel.EndpointAddress);
            if (needLogInfo) Logger.Info(method, eDomain, null, string.Format("{0}.{1} BeginInvoke.", typeof(TChannel).FullName, func.Method.Name));
        ...
        {
            var method = Logger.GetMethodInfo(func.Method, new object[] { t1, t2, t3, t4, t5 }, channel.EndpointAddress);
            if (needLogInfo) Logger.Info(method, eDomain, null, string.Format("{0}.{1} BeginInvoke.", typeof(TChannel).FullName, func.Method.Name));
        ...
        {
            var method = Logger.GetMethodInfo(func.Method, new object[] { t1, t2, t3, t4, t5, t6 }, channel.EndpointAddress);
            if (needLogInfo) Logger.Info(method, eDomain, null, string.Format("{0}.{1} BeginInvoke.", typeof(TChannel).FullName, func.Method.Name));
        ...
        {
            var method = Logger.GetMethodInfo(func.Method, new object[] { t1, t2, t3, t4, t5, t6, t7 }, channel.EndpointAddress);
            if (needLogInfo) Logger.Info(method, eDomain, null, string.Format("{0}.{1} BeginInvoke.", typeof(TChannel).FullName, func.Method.Name));
        ...
        {
            var method = Logger.GetMethodInfo(func.Method, new object[] { t1, t2, t3, t4, t5, t6, t7, t8 }, channel.EndpointAddress);
            if (needLogInfo) Logger.Info(method, eDomain, null, string.Format("{0}.{1} BeginInvoke.", typeof(TChannel).FullName, func.Method.Name));
        ...
        {
            var method = Logger.GetMethodInfo(func.Method, new object[] { t1, t2, t3, t4, t5, t6, t7, t8, t9 }, channel.EndpointAddress);
            if (needLogInfo) Logger.Info(method, eDomain, null, string.Format("{0}.{1} BeginInvoke.", typeof(TChannel).FullName, func.Method.Name));
        ...
        {
            var method = Logger.GetMethodInfo(func.Method, new object[] { t1, t2, t3, t4, t5, t6, t7, t8, t9, t10 }, channel.EndpointAddress);
            if (needLogInfo) Logger.Info(method, eDomain, null, string.Format("{0}.{1} BeginInvoke.", typeof(TChannel).FullName, func.Method.Name));
        ...
        {
            var method = Logger.GetMethodInfo(func.Method, new object[] { t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11 }, channel.EndpointAddress);
            if (needLogInfo) Logger.Info(method, eDomain, null, string.Format("{0}.{1} BeginInvoke.", typeof(TChannel).FullName, func.Method.Name));
        ...
        {
            var method = Logger.GetMethodInfo(func.Method, new object[] { t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12 }, channel.EndpointAddress);
            if (needLogInfo) Logger.Info(method, eDomain, null, string.Format("{0}.{1} BeginInvoke.", typeof(TChannel).FullName, func.Method.Name));
        ...
        {
            var method = Logger.GetMethodInfo(func.Method, new object[] { t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13 }, channel.EndpointAddress);
            if (needLogInfo) Logger.Info(method, eDomain, null, string.Format("{0}.{1} BeginInvoke.", typeof(TChannel).FullName, func.Method.Name));
        ...
        {
            var method = Logger.GetMethodInfo(func.Method, new object[] { t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14 }, channel.EndpointAddress);
            if (needLogInfo) Logger.Info(method, eDomain, null, string.Format("{0}.{1} BeginInvoke.", typeof(TChannel).FullName, func.Method.Name));
        ...
        {
            var method = Logger.GetMethodInfo(func.Method, new object[] { t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15 }, channel.EndpointAddress);
            if (needLogInfo) Logger.Info(method, eDomain, null, string.Format("{0}.{1} BeginInvoke.", typeof(TChannel).FullName, func.Method.Name));
        ...
        {
            var method = Logger.GetMethodInfo(func.Method, new object[] { t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16 }, channel.EndpointAddress);
            if (needLogInfo) Logger.Info(method, eDomain, null, string.Format("{0}.{1} BeginInvoke.", typeof(TChannel).FullName, func.Method.Name));
