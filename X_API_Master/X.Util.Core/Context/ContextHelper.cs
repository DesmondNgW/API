...
namespace X.Util.Core.Context
{
    ...
    {
        public static List<IContext<TResult, TChannel>> GetContext<TResult, TChannel>(IProvider<TChannel> channel, Func<TResult, bool> callSuccess, bool needElapsed, bool needLogInfo)
        {
        ...
        public static List<IContext<TChannel>> GetContext<TChannel>(IProvider<TChannel> channel, bool needElapsed, bool needLogInfo)
        {
