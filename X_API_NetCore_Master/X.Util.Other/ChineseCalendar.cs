        ...
        public string NewCalendarHoliday
        {
            get
            {
                ...
                if (IsChineseLeapMonth == false) //闰月不计算节日
                {
                    ...
                    {
                        if ((lh.Month == this._cMonth) && (lh.Day == this.ChineseDay))
                        {
            ...
            get
            {
                switch (this.ChineseDay)
                {
                    ...
                    case 30:
                        return "三十";
                    default:
                        return nStr2[(int)(ChineseDay / 10)].ToString() + nStr1[ChineseDay % 10].ToString();
