...
namespace X.Util.Other
{
    public class ImageHelper
    {
        ...
        public static void MakeThumbnail(string originalImagePath, string thumbnailPath, int width, int height, string mode)
        {
            ...
            {
                Logger.Client.Error(Logger.Client.GetMethodInfo(MethodBase.GetCurrentMethod(), new object[] { originalImagePath, thumbnailPath, width, height, mode }), e, LogDomain.Util);
            }
            finally
            {
        ...
        public static Bitmap ResizeImage(Bitmap bmp, int newW, int newH)
        {
            ...
            {
                Logger.Client.Error(Logger.Client.GetMethodInfo(MethodBase.GetCurrentMethod(), new object[] { bmp, newW, newH }), ex, LogDomain.Util);
                return null;
            }
        }
        #endregion
