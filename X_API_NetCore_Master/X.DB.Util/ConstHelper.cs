namespace X.DB.Util
{
    public class ConstHelper
    {
        ...
        public const string UserManagerCode2 = "密码必须包含数字、大写字母、小写字母、特殊字符中的三种以及以上";

        public const string UserManagerCode3 = "手机号码格式不正确";

        public const string UserManagerCode4 = "邮箱格式不正确";
